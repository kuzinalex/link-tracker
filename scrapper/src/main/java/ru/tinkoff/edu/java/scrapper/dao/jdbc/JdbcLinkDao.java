...
public class JdbcLinkDao implements LinkDao {
    ...
    private static final String SQL_INSERT_LINK = "INSERT INTO link (url) VALUES (?)";
    private static final String SQL_UPDATED_LINK = "UPDATE link SET updated_at=(?), check_time=NOW() WHERE id=(?)";
    private static final String SQL_REMOVE_LINK = "DELETE FROM link WHERE id=(?)";
    private static final String SQL_FIND_LINK = "SELECT * FROM link WHERE url=(?)";
    private static final String SQL_FIND_ALL_LINKS = "SELECT * FROM link JOIN subscription s on link.id = s.link_id WHERE chat_id=(?)";
    private static final String SQL_FIND_OLD_LINKS = "SELECT * FROM link WHERE check_time<=(?)";
