...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record4<Long, String, LocalDateTime, LocalDateTime> {
    ...
    /**
     * Setter for <code>public.link.check_time</code>.
     */
    ...
    /**
     * Getter for <code>public.link.check_time</code>.
     */
    @Nullable
     ...
     */
    @ConstructorProperties({ "id", "url", "checkTime", "updatedAt" })
    public LinkRecord(@NotNull Long id, @NotNull String url, @Nullable LocalDateTime checkTime, @Nullable LocalDateTime updatedAt) {
        super(Link.LINK);
