...
public class TrackCommand implements Command {
    ...
    private static final String LINK_ADDED = "Ссылка добавлена: ";
    private static final String PLACE_HOLDER = "Ссылка на GitHub или StackOverflow";
    private static final String NOT_VALID_LINK = "Неверный формат ссылки";
